...
if (!$found_item_again_check && $kill_item_defined ) { // if item NOT found in reward items THEN create it OR item
$items1 = <<<ITEMS
...
SENT;
*/
if($villain_defined && $kill_item_defined) {  /// ????????? $item or $reward_item GOES HERE *******
$sentence1=<<<SENT
...
//-----$usercheckblocks_text-----------------------------------------------------------
if($villain_defined){  //here might need to disable block if villain exist & kill item not.... ?????
  $checkblock1='
